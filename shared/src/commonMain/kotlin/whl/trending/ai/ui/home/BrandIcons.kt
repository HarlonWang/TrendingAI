...
fun hackerNewsIcon(bgColor: Color): ImageVector {
    ...
    val innerPadding = 6f    // Y 字母与方形边缘的额外间距
    ...
    return ImageVector.Builder(
        ...
        path(fill = SolidColor(Color.White)) {
            // 加粗 Y：竖杆宽 8.6（原 5.7），左右笔画宽 8.6（原 6.6）
            moveTo(36.3f + yOffset, 37.5f + yOffset)
            verticalLineTo(54f + yOffset)
            horizontalLineTo(27.7f + yOffset)
            verticalLineTo(37.5f + yOffset)
            lineTo(12.5f + yOffset, 8f + yOffset)
            horizontalLineTo(21.1f + yOffset)
            lineTo(32f + yOffset, 28.5f + yOffset)
            lineTo(42.9f + yOffset, 8f + yOffset)
            horizontalLineTo(51.5f + yOffset)
            close()
        }
    }.build()
}
