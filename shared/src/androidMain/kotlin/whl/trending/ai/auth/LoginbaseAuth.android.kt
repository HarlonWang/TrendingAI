 ...
 */
fun initLoginbaseAuth(context: Context, redirectUri: String): LoginbaseAuthManager =
    initLoginbaseAuth(SharedPreferencesTokenStore(context.applicationContext), redirectUri)
